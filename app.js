...
var CAT_ICONS={'🔐':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="11" width="14" height="9" rx="2.2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/></svg>','🔑':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.5" cy="15.5" r="3.3"/><path d="M9.8 13.2L18 5"/><path d="M14.3 9.7l2 2"/><path d="M17.3 6.7l2 2"/></svg>','🎣':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5.5" width="18" height="13" rx="2"/><path d="M3.5 7l8.5 6 8.5-6"/></svg>','🦠':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="7.5" y="9" width="9" height="9.5" rx="4"/><path d="M9.5 9V7.2a2.5 2.5 0 0 1 5 0V9"/><path d="M4.5 12.5h3M16.5 12.5h3M5.5 8l2 1.6M18.5 8l-2 1.6M5.5 17l2-1.6M18.5 17l-2-1.6M12 4.5v2.2"/></svg>','🌐':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8.3"/><path d="M3.7 12h16.6"/><path d="M12 3.7c2.4 2.3 3.7 5.2 3.7 8.3s-1.3 6-3.7 8.3c-2.4-2.3-3.7-5.2-3.7-8.3S9.6 6 12 3.7z"/></svg>','👤':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8.2" r="3.4"/><path d="M5 19.5c0-3.7 3.1-6.6 7-6.6s7 2.9 7 6.6"/></svg>','📱':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="7.2" y="2.7" width="9.6" height="18.6" rx="2.1"/><path d="M11 18.4h2"/></svg>','🕵️':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12s3.4-6.3 9-6.3 9 6.3 9 6.3-3.4 6.3-9 6.3-9-6.3-9-6.3z"/><circle cx="12" cy="12" r="2.5"/></svg>','🧠':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8.3"/><path d="M8 12.4l2.6 2.6L16 9.6"/></svg>'};
function renderLearn(){
  ...
  document.getElementById('learnCats').innerHTML = cats.map(function(cat,i){
    ...
    return '<div class="cat" id="cat-'+i+'">'
      ...
      + '<div class="cat-head-left"><div class="icon-box" style="background:'+bg+';color:'+fg+';">'+(CAT_ICONS[cat.icon]||cat.icon)+'</div>'
...
(function buildHackRain(){
  ...
  for(var i=0;i<cols;i++){
    ...
    col.style.animationDuration=(1.1+Math.random()*0.7)+'s';
